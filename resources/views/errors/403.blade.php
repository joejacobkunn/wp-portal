...
<head>
    ...
    <link rel="shortcut icon"
        ...
        type="image/png">
    <link rel="stylesheet" crossorigin="" href="/assets/css/main/app.css">
    <link rel="stylesheet" crossorigin="" href="/assets/css/main/error.css">
</head>
        ...
        <div class="error-page container">
            <div class="col-md-8 col-12 offset-md-2 mt-4">
                <div class="text-center">
                    <img class="img-error" src="/assets/images/error-403.svg" alt="Forbidden" height="400">
                    <h1 class="error-title">Forbidden</h1>
                    <p class="fs-5 text-gray-600">
                        {{ $exception->getMessage() ?? "You don't have sufficient permissions to view this page " }}
                    </p>
