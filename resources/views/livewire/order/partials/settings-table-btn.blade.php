    ...
    <div class="dropdown-tab text-center" x-data="{ isOpen: false }">
        ...
        <div x-show="isOpen" @click.away="isOpen = false" class="popup custom-width">
            <div class="popup-content">
                <a class="popup-item d-flex justify-content-between align-items-center" wire:navigate
                    href="{{ route('order.email-template.index') }}">Templates</a>
                <a class="popup-item d-flex justify-content-between align-items-center" wire:click="export">Reports</a>

                <a class="popup-item d-flex justify-content-between align-items-center" @click="isOpen = false"
                    wire:click="$toggle('enableEcomZwhs')">Show ECOM and ZWHS :
                ...
                <div class="popup-item d-flex justify-content-between align-items-center">
                    ...
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault"
                            wire:model="isFilterSaved" wire:change="saveFilter"
