                                        ...
                                        @if (!empty($this->order_line_items))
                                            @forelse ($this->order_line_items as $item)
                                                <a href="https://weingartz.com//searchPage.action?keyWord={{ $item->shipprod }}"
                                                    target="_blank"
                                                    class="list-group-item list-group-item-action @if (in_array($item->shipprod, Illuminate\Support\Arr::pluck($this->dnr_line_items, 'shipprod'))) list-group-item-danger @elseif (in_array($item->shipprod, $this->backorder->dnr_items ?? [])) border border-warning border-4 @endif"
                                                    aria-current="true">
