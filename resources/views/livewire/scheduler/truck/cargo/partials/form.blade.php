        ...
        <div class="col-12 col-md-12">
            <div class="card card-body shadow-sm mb-2">
                <div class="row">
                    ...
                    <!-- equpiment category -->
                    <div class="col-md-6 mb-3">
                        <x-forms.select label="SRO Equipment Category" model="cargoForm.sro_equipment_category_id" :options="$equipmentCategories" :selected="$cargoForm->sro_equipment_category_id"
                            :hasAssociativeIndex="true" default-selectable default-option-label="- Select Category -" />
                    </div>
                </div>
