<div wire:init="init" >
    ...
    <div class="card border-light shadow-sm mb-4">
        ...
        <div class="card-body">
            ...
            <p>To create a new API key, click on following link:</p>
            <button wire:click="openGenerateKeyModal" class="btn btn-primary btn-sm"><i class="fa-solid fa-plus"></i> Create API Key</button>   
    ...
    <x-modal :toggle="$generateKeyModal">
        ...
        <x-slot name="footer">
            <button wire:click="generateKey" type="button" class="pre-genkey-div btn btn-danger">Generate</button>
