    ...
    <div class="card border-light shadow-sm mb-4">
        <div class="card-header border-gray-300 p-3 mb-4 mb-md-0">
            ...
            <div class="card-body">
                ...
                @if (!$defaultLoad)
                    <div>
                        <button type="button" class="btn btn-pill btn-outline-gray-500" wire:click="loadLogs()">Click to
                            Load..</button>
                    </div>
                @else
                    @forelse($logs as $log)
                        <div class="my-2">
                            ...
                            <span class="timestamp-div" title="{{ $log['timestamp'] }}"><i class="far fa-clock"></i>
                                {{ $log['timestamp_string'] }}</span>
