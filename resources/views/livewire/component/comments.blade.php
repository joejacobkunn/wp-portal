<div>
     <div  {{ !empty($deferLoad) ? 'wire:init=loadComments' : '' }} wire:loading.class="loading-skeleton" wire:target="loadComments" class="card border-light shadow-sm mb-4">
            ...
            <div class="card-body">
                <form wire:submit.prevent="createComment()" class="mt-1 mb-4">     
                    <x-forms.html-editor
                        ...
                        :value="$comment"
                        noLabel
                        listener="commentFieldUpdated"
                        :key="'comment-field' . $editorId"
                    />
                    <div class="d-flex justify-content-between align-items-center mt-1">
                        <div>
                            <button type="submit"
                                ...
                                class="btn btn-secondary d-inline-flex align-items-center text-dark">
                        ...
                        <div class="card border-0 shadow p-4 mb-4 comment-card">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <span class="font-small">
                                    <a href="#">
                                        <img class="avatar-sm img-fluid rounded-circle me-2" src="/img/icons/account.png" alt="avatar"> <span class="fw-bold">{{$comment['user']['name_full'] }}</span> 
                                    </a>
