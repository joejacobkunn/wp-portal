<div>
    <x-page :breadcrumbs="$breadcrumbs">
        ...
        <x-slot:title>Kenect SMS Marketing</x-slot>
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <div wire:loading.remove wire:target="importData">
                                @if ($addRecord)
                                    @include('livewire.marketing.sms-marketing.partials.form', [
                                        'button_text' => 'Import',
                                    ])
                                @else
                                    <div wire:poll.5s="refreshStatus">
                                        <livewire:marketing.s-m-s-marketing.table wire:key="imt-{{ $smsImportTableId }}"
                                            lazy>
                                    </div>
                                @endif
                            </div>
