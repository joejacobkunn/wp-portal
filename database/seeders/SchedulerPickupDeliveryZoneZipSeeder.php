...
class SchedulerPickupDeliveryZoneZipSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $reader = Reader::createFromPath(base_path() . '/database/seeders/seeds/scheduler-pickup-delivery-zone-zip-data.csv', 'r');
