...
class CheckboxGroup extends Component
{
    ...
    /**
     * @var String Checkbox field name
     */
    public $name;
    ...
    /**
     * @var String Help tooltip index
     */
    public $hintIndex;

    /**
     * @var Boolean show checkbox group in vertical
     */
    public $vertical;

    /**
     * @var String Checkbox group grid
     */
    public $cols;
     ...
     * @return void
     */
    public function __construct($name, $items, $model, $label = null, $labelIndex = null, $valueIndex = null, $hintIndex = null, $cols = 'col-md-3', $vertical = false)
    {
        $this->name = $name;
        $this->model = $model;
        $this->label = $label;
