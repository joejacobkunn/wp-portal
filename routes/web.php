...
Route::group(['domain' => '{route_subdomain}.'.config('app.domain'), 'middleware' => 'subdomain'], function () {
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::get('orders/email-templates', \App\Http\Livewire\Order\EmailTemplate\Index::class)->name('order.email-template.index');
        Route::get('orders/email-templates/{template}/show', \App\Http\Livewire\Order\EmailTemplate\Show::class)->name('order.email-template.show');
