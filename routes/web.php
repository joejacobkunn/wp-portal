...
Route::group(['domain' => '{route_subdomain}.'.config('app.domain'), 'middleware' => 'subdomain'], function () {
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::get('equipment/floor-model-inventory/{id}/show', \App\Http\Livewire\Equipment\FloorModelInventory\Show::class)->name('equipment.floor-model-inventory.show');
